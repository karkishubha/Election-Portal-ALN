import { Megaphone, Plus, Edit2, Trash2, Eye, EyeOff, Loader2, RefreshCw } from "lucide-react";
...
import {
  useAdminMisinformation,
  useCreateMisinformation,
  useUpdateMisinformation,
  useDeleteMisinformation,
  useToggleMisinformationPublish,
} from "@/hooks/useQueries";
import { uploadApi } from "@/lib/api";

const AdminMisinformation = () => {
  ...
  const { data, isLoading, isError, refetch } = useAdminMisinformation(page);
  const createMutation = useCreateMisinformation();
  const updateMutation = useUpdateMisinformation();
  const deleteMutation = useDeleteMisinformation();
  const togglePublishMutation = useToggleMisinformationPublish();
  ...
  const handleAddResource = async () => {
    ...
    try {
      ...
      if (selectedFile) {
        const uploadResult = await uploadApi.uploadPdf(selectedFile, 'misinformation');
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground">
              Manage misinformation reports and related documents
            </p>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="bg-card">
                <DialogHeader>
                  <DialogTitle>Add New Misinformation</DialogTitle>
                </DialogHeader>
                <div className="space-y-4 pt-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="title"
                      placeholder="Misinformation title"
            ...
            <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
              <DialogContent className="bg-card">
                <DialogHeader>
                  <DialogTitle>Edit Misinformation</DialogTitle>
                </DialogHeader>
                <div className="space-y-4 pt-4">
                  <div className="space-y-2">
                  ...
                  {resources.length === 0 ? (
                    <tr>
                      <td colSpan={3} className="p-8 text-center text-muted-foreground">
                        No misinformation entries found. Add your first one!
                      </td>
                    </tr>
                  ) : (
...
export default AdminMisinformation;
