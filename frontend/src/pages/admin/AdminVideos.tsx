import { Video, Plus, Edit2, Trash2, Eye, EyeOff, Loader2, RefreshCw, Link as LinkIcon } from "lucide-react";
...
const AdminVideos = () => {
  ...
  const { data, isLoading, isError, refetch } = useAdminVideos(page);
  const createMutation = useCreateVideo();
  const updateMutation = useUpdateVideo();
  const deleteMutation = useDeleteVideo();
  const togglePublishMutation = useToggleVideoPublish();
  ...
  const handleAddResource = async () => {
    ...
    try {
      ...
      if (selectedFile) {
        const uploadResult = await uploadApi.uploadPdf(selectedFile, 'videos');
      ...
      await createMutation.mutateAsync({
        ...
        resourceUrl: resourceUrl || "/placeholder.mp4",
      });
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-section-education/20">
                <Video className="w-5 h-5 text-section-education" />
              </div>
            ...
            <p className="text-muted-foreground">
              Manage voter education videos and related resources
            </p>
          </div>
              ...
              <DialogContent className="bg-card">
                ...
                <div className="space-y-4 pt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input type="file" accept=".mp4,.mov,.mkv,.webm" onChange={handleFileChange} />
                    {selectedFile && (
