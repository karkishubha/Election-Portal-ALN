  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        section: {
          voter: "hsl(var(--section-voter))",
          integrity: "hsl(var(--section-integrity))",
          monitoring: "hsl(var(--section-monitoring))",
          parties: "hsl(var(--section-parties))",
        },
      },
      fontFamily: {
